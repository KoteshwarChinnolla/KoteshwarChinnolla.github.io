...
const FloatingDocsButton = () => {
  ...
  return (
    <div ref={ref} className="fixed bottom-5 left-5 z-50 md:bottom-8 md:left-8">
      {open && (
        <div className="absolute bottom-full left-0 mb-3 w-72 rounded-2xl bg-card/95 backdrop-blur-md shadow-2xl ring-1 ring-border p-3 animate-scale-in origin-bottom-left">
