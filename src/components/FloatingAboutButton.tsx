...
const FloatingAboutButton = () => {
  ...
  return (
    <Link
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-card/80 backdrop-blur-md pl-2 pr-4 py-2 shadow-2xl ring-1 ring-border hover:ring-[hsl(38,92%,55%)]/60 transition-all hover:scale-105 md:bottom-8 md:right-8"
    >
